...
def fill_mail_tracking_value_track_sequence_default(env):
    """Faster way to fill this new field"""
    openupgrade.logged_query(
        env.cr, """
        ALTER TABLE mail_tracking_value
        ADD COLUMN track_sequence integer
        DEFAULT 100""",
    )
...
def migrate(env, version):
    ...
    fill_mail_tracking_value_track_sequence_default(env)
