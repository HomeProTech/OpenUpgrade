...
class AccountAnalyticLine(models.Model):
    ...
    currency_id = fields.Many2one(related="company_id.currency_id", string="Currency", store=False, readonly=True, compute_sudo=True)
    group_id = fields.Many2one('account.analytic.group', related='account_id.group_id', store=False, readonly=True, compute_sudo=True)
